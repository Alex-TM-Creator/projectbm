...
export default function PrintPaymentOrderPage() {
  const { id } = useParams();
        ...
        <Card className="print:shadow-none print:border-none">
          ...
          <CardContent className="space-y-6">
           ...
           <CardFooter className="flex-col items-center justify-center text-xs text-muted-foreground pt-6">
             <p className="text-center">Este é um documento gerado pelo sistema Conecta para fins de controle de pagamento de premiações.</p>
